...
const initialIntegrations: Integration[] = [
  ...
  },
  {
    ...
    description: 'Passkey-authenticated smart contract wallets powered by Circle Modular Wallets.',
    status: 'live',
    docs: 'https://developers.circle.com/wallets/smart-accounts',
    method: 'Circle Smart Account with WebAuthn biometrics and gasless transaction sponsorship.',
