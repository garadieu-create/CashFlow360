...
export function EURCIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function CirBTCIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArcIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function EthereumIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArbitrumIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function BaseIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TokenOrChainIcon({ name, size = 18, className }: { name: string; size?: number; className?: string }) {
  const normName = name.toLowerCase().trim()
  
  if (normName === 'usdc') return <USDCIcon size={size} />
  if (normName === 'eurc') return <EURCIcon size={size} />
  if (normName === 'cirbtc' || normName === 'btc') return <CirBTCIcon size={size} />
  if (normName === 'arc' || normName.includes('arc testnet')) return <ArcIcon size={size} />
  if (normName === 'ethereum' || normName === 'eth' || normName.includes('ethereum') || normName.includes('sepolia') && normName.includes('eth')) return <EthereumIcon size={size} />
  if (normName === 'arbitrum' || normName === 'arb' || normName.includes('arbitrum')) return <ArbitrumIcon size={size} />
  if (normName === 'base' || normName.includes('base')) return <BaseIcon size={size} />
