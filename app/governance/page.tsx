...
export default function GovernancePage() {
  ...
  const { requests, isLoading, refetch } = useMultiSigRequests();
      ...
      <div className="flex-between" style={{ marginBottom: 'var(--space-lg)' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div className="sidebar-logo-icon" style={{ background: 'var(--ph-red)' }}>
              <Shield size={16} />
            </div>
            <h1 className="h2" style={{ margin: 0 }}>Multi-Sig Governance</h1>
          </div>
          <p className="text-secondary" style={{ marginTop: 6, fontSize: 13 }}>
            Dual-Signature vault control policies. Outflows &gt; $10,000 USDC require Passkey + Autonomous Agent approvals.
          </p>
        </div>
              ...
              <div className="card-body" style={{ padding: 0 }}>
                {isLoading ? (
                  <div style={{ padding: 40, textAlign: 'center', color: 'var(--text-secondary)' }}>
                    Loading governance requests backlog...
                  </div>
              ...
              <div className="card-body" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <form onSubmit={handleUpdateCoSigner} style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <button
                    ...
                    disabled={updatingCoSigner}
                  >
                    {updatingCoSigner ? 'Updating...' : 'Register Co-Signer'}
                  </button>
                </form>
              </div>
            </div>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <button
                  ...
                  style={{ width: '100%' }}
                >
                  {passkeyVerifying ? 'Verifying Credentials...' : 'Scan Passkey'}
                </button>
                <button
